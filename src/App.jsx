...
const places = AVAILABLE_PLACES.filter((place) => storedIds.includes(place.id));
...
function App() {
  ...
  const handleRemovePlace = useCallback(() => {
    ...
    const updatedStoredIds = JSON.stringify(
      storedIds.filter((id) => id !== selectedPlace.current)
    );

    localStorage.setItem("pickedPlaces", updatedStoredIds);
  }, []);
